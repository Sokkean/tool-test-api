...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, users_module_1.UsersModule, auth_module_1.AuthModule, workspace_module_1.WorkspaceModule, requests_module_1.RequestsModule],
        controllers: [],
        providers: [],
    })
], AppModule);
