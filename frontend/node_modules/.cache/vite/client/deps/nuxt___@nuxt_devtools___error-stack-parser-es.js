...
function parse2(error, options) {
  return stackframesLiteToStackframes(parse(error, options));
}
function parseV8OrIE2(error) {
  return stackframesLiteToStackframes(parseV8OrIE(error));
}
function parseFFOrSafari2(error) {
  return stackframesLiteToStackframes(parseFFOrSafari(error));
}
function parseOpera2(e) {
  return stackframesLiteToStackframes(parseOpera(e));
}
function parseOpera92(e) {
  return stackframesLiteToStackframes(parseOpera9(e));
}
function parseOpera102(e) {
  return stackframesLiteToStackframes(parseOpera10(e));
}
function parseOpera112(error) {
  return stackframesLiteToStackframes(parseOpera11(error));
}
export {
  extractLocation,
  parse2 as parse,
  parseFFOrSafari2 as parseFFOrSafari,
  parseOpera2 as parseOpera,
  parseOpera102 as parseOpera10,
  parseOpera112 as parseOpera11,
  parseOpera92 as parseOpera9,
  parseV8OrIE2 as parseV8OrIE
};
//# sourceMappingURL=nuxt___@nuxt_devtools___error-stack-parser-es.js.map
