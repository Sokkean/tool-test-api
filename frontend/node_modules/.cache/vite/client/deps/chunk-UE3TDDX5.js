import {
  getIconifySvg
} from "./chunk-SMVGTIMG.js";
import {
  DEFAULT_STATE_USER_SETTINGS,
  KNOWN_BROWSER_SHORTCUTS,
  ...
  getEntryGroup,
  getGroupMembers,
  isDockPopupSupported,
  isKeybindingOverrideDifferentFromDefault,
  isMac,
  onClickOutside,
  requestDockPopupOpen,
  setDockContextMenu,
  setDocksGroupPanel,
  ...
  useDockContextMenu,
  useDocksGroupPanel,
  useDocksOverflowPanel,
  useDraggable,
  useEdgePositionDropdown,
  useEventListener,
  useFloatingTooltip,
  useIsDockPopupOpen,
  useTimeAgo,
...
// node_modules/@vitejs/devtools/dist/DockStandalone-ojaaAKG8.js
...
var isLeaf = (query) => !isArray(query) && isObject$1(query) && !isExpression(query);
...
function useStorage(key, defaults, storage, options = {}) {
  ...
  if (window2 && listenToStorageChanges) if (storage instanceof Storage) useEventListener2(window2, "storage", onStorageEvent, { passive: true });
  else useEventListener2(window2, customStorageEventName, onStorageCustomEvent);
...
var _hoisted_3$15 = ["fill"];
var _hoisted_4$11 = ["fill"];
...
var _hoisted_1$22 = ["innerHTML"];
var _hoisted_2$16 = ["src"];
...
var VitePlusCore_default = export_helper_default(_sfc_main$27, [["render", _sfc_render$1]]);
...
var _hoisted_1$19 = { class: "flex items-center gap-0.5" };
...
var _hoisted_2$15 = { class: "flex items-center gap-2 flex-1 of-hidden min-w-0" };
var _hoisted_3$14 = { class: "flex-1 min-w-0" };
var _hoisted_4$10 = { class: "flex items-center gap-1.5" };
var _hoisted_5$10 = { class: "truncate" };
var _hoisted_6$9 = {
  key: 0,
  class: "op50"
};
...
var _hoisted_9$3 = { class: "flex items-center gap-1.5 flex-none" };
var _hoisted_10$3 = {
  key: 0,
...
var _hoisted_1$17 = { class: "absolute inset-0 flex items-start justify-center relative pt-[20vh] pointer-events-none" };
var _hoisted_2$14 = { class: "w-full w-lg bg-base border border-base rounded-lg shadow-xl pointer-events-auto of-hidden flex flex-col max-h-[60vh]" };
var _hoisted_3$13 = { class: "border-b border-base flex items-center px-3" };
var _hoisted_4$9 = ["onClick"];
var _hoisted_5$9 = { class: "flex-1 of-y-auto p-1.5" };
var _hoisted_6$8 = {
  key: 0,
  class: "py-8 flex flex-col items-center justify-center gap-2 op50 text-sm"
};
var _hoisted_7$5 = { key: 0 };
var _hoisted_8$2 = { class: "text-primary op100" };
var _hoisted_9$2 = { key: 1 };
var _hoisted_10$2 = { class: "border-t border-base flex items-center justify-between gap-4 px-3 py-1.5 text-[10px] op50" };
var _hoisted_11$2 = { class: "flex items-center gap-1.5" };
var _sfc_main$23 = defineComponent({
  ...
  setup(__props) {
    ...
    const filtered = computed(() => {
      if (!search2.value) return activeItems.value;
      return fuse.value.search(search2.value).map((i) => i.item);
    });
    watch(search2, () => {
    ...
    function onKeyDown(e) {
      if (e.key === "Backspace" && !search2.value && (breadcrumb.value.length > 0 || dynamicItems.value)) {
        e.preventDefault();
        goBack();
      }
    }
        ...
        createElementVNode("div", _hoisted_1$17, [createElementVNode("div", { class: normalizeClass(["flex flex-col transition-all duration-150", visible.value ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-98 -translate-y-2"]) }, [createVNode(_sfc_main$29, { class: "absolute top--32px left-5px w-60 pointer-events-none" }), createElementVNode("div", _hoisted_2$14, [
          ...
          createElementVNode("header", _hoisted_3$13, [
            ...
            withDirectives(createElementVNode("input", {
              ...
              onKeydown: onKeyDown
            }, null, 544), [[vModelText, search2.value]])
          ]),
          ...
          }), 128)), !filtered.value.length ? (openBlock(), createElementBlock("div", _hoisted_6$8, [_cache[4] || (_cache[4] = createElementVNode("div", { class: "i-ph-magnifying-glass-duotone w-6 h-6" }, null, -1)), search2.value ? (openBlock(), createElementBlock("div", _hoisted_7$5, [
            _cache[2] || (_cache[2] = createTextVNode(' No results for "', -1)),
            createElementVNode("strong", _hoisted_8$2, toDisplayString(search2.value), 1),
...
var ConfirmPromise = createTemplatePromise({ singleton: true });
function useConfirm() {
  return ConfirmPromise.start;
}
var _hoisted_1$16 = ["aria-labelledby", "onKeydown"];
var _hoisted_2$13 = ["onClick"];
var _hoisted_3$12 = { class: "relative w-full max-w-96 bg-base border border-base rounded-lg shadow-xl p-5" };
var _hoisted_4$8 = {
  key: 0,
  id: "vite-devtools-confirm-title",
  class: "text-sm font-medium leading-5"
};
var _hoisted_5$8 = { class: "flex items-center justify-end gap-2 mt-6" };
...
function addToast(entry) {
  ...
  if (existing) {
    ...
    const timeout2 = entry.autoDismiss ?? 5e3;
    timers.set(entry.id, setTimeout(dismissToast, timeout2, entry.id));
    return;
  }
  const item = {
    id: entry.id,
...
var _sfc_main$19 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(toasts2).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$14, [createVNode(TransitionGroup, {
        "enter-active-class": "transition-all duration-300 ease-out",
        "leave-active-class": "transition-all duration-200 ease-in",
        "enter-from-class": "opacity-0 translate-x-4",
        "leave-to-class": "opacity-0 translate-x-4"
      }, {
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(toasts2), (toast) => {
...
var DETECT_MARGIN = 100;
var DEFAULT_GAP = 10;
var FloatingPopoverComponent = defineComponent({
...
var _hoisted_1$12 = { class: "flex items-center gap-1.5 px2 pt1 pb1.5 op60 text-2.75 uppercase tracking-wide font-medium" };
var _hoisted_2$10 = { class: "truncate" };
var _hoisted_3$9 = ["onClick"];
var _hoisted_4$6 = { class: "truncate flex-1" };
var _hoisted_5$6 = {
  key: 0,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        onMousemove: _cache[0] || (_cache[0] = withModifiers(() => {
        }, ["stop"]))
      }, [
...
var VitePlus_default = export_helper_default(_sfc_main$12, [["render", _sfc_render]]);
var _hoisted_1$10 = { class: "w-full h-full flex flex-col items-center justify-center p20" };
var _hoisted_2$9 = { class: "max-w-150 flex flex-col items-center justify-center gap-2" };
...
var _hoisted_1$9 = { class: "flex flex-col gap-6" };
...
var _hoisted_1$8 = { class: "flex flex-col gap-4" };
var _hoisted_2$8 = {
  key: 0,
  class: "flex flex-col gap-2"
};
var _hoisted_3$7 = { class: "flex items-center gap-1 bg-gray/10 rounded-lg p1 w-fit" };
var _hoisted_4$5 = ["onClick"];
var _hoisted_5$5 = { class: "flex items-center gap-3 cursor-pointer group" };
var _hoisted_6$4 = { class: "flex items-center gap-3 cursor-pointer group" };
...
var _hoisted_2$7 = { class: "flex items-center gap-2 px-4 py-3 bg-gray/5 cursor-pointer select-none border-b border-base" };
var _hoisted_3$6 = ["disabled", "onClick"];
var _hoisted_4$4 = { class: "font-medium capitalize" };
var _hoisted_5$4 = { class: "text-xs op40" };
var _hoisted_6$3 = ["onClick"];
var _hoisted_7$2 = ["data-dock-id", "data-container"];
var _hoisted_8$1 = [
  "disabled",
  "title",
  "onClick"
...
var _hoisted_10$1 = { class: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity" };
var _hoisted_11$1 = ["onClick"];
var _hoisted_12$1 = ["onClick"];
var _hoisted_13$1 = ["title", "onClick"];
var _hoisted_14$1 = {
  key: 0,
  class: "px-2 py-2 text-xs op40 italic border-b border-base border-t-0"
};
var _hoisted_15$1 = ["data-dock-id", "data-container"];
var _hoisted_16$1 = ["title", "onClick"];
var _hoisted_17$1 = {
  key: 0,
  class: "i-ph-check-bold text-xs"
};
var _hoisted_18$1 = { class: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity" };
var _hoisted_19$1 = ["onClick"];
var _hoisted_20$1 = ["onClick"];
var _hoisted_21$1 = ["title", "onClick"];
...
var _hoisted_1$6 = { class: "mb-3" };
var _hoisted_2$6 = { class: "border border-base rounded-lg overflow-hidden" };
var _hoisted_3$5 = { class: "flex-1 min-w-0" };
var _hoisted_4$3 = { class: "flex items-center gap-1.5" };
var _hoisted_5$3 = { class: "truncate text-sm" };
var _hoisted_6$2 = {
  key: 0,
...
var _hoisted_8 = { class: "flex items-center gap-1.5 shrink-0" };
...
var _hoisted_15 = { class: "relative bg-base border border-base rounded-lg shadow-xl w-96 p-5" };
var _hoisted_16 = { class: "mb-4" };
var _hoisted_17 = ["value"];
var _hoisted_18 = { class: "flex items-center gap-2 mb-4" };
var _hoisted_19 = {
  key: 0,
  class: "mb-4 flex flex-col gap-1.5"
};
var _hoisted_20 = { class: "flex items-center justify-end gap-2" };
...
var _hoisted_1$5 = { class: "h-full w-full overflow-hidden flex flex-col" };
var _hoisted_2$5 = { class: "flex items-center border-b border-base px-6 shrink-0" };
var _hoisted_3$4 = ["onClick"];
var _hoisted_4$2 = {
  key: 0,
  class: "absolute bottom-0 left-2 right-2 h-0.5 bg-primary rounded-full"
};
var _hoisted_5$2 = { class: "flex-1 overflow-auto p8" };
var _hoisted_6$1 = { class: "max-w-200 mx-auto" };
...
var _hoisted_1$4 = { class: "w-full h-full flex flex-col" };
var _hoisted_2$4 = { class: "flex-1 flex items-center h-7 px-2.5 rounded bg-gray/5 border border-transparent hover:border-gray/10 focus-within:border-gray/15 transition-colors" };
var _hoisted_3$3 = ["value", "readonly"];
var _hoisted_4$1 = {
  key: 0,
...
var _hoisted_1$3 = { class: "flex flex-col gap-4 items-center justify-center h-full relative" };
var _hoisted_2$3 = { class: "text-2xl font-bold" };
...
var _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    const ViewBuiltinTerminals = defineAsyncComponent(() => import("./ViewBuiltinTerminals-eTwVypq7-A6X7E7MI.js"));
    const ViewBuiltinMessages = defineAsyncComponent(() => import("./ViewBuiltinMessages-C0Tl0U0O-KAQF7SUG.js"));
    const ViewJsonRender = defineAsyncComponent(() => import("./ViewJsonRender-C9d97sEx-YXG7JR6A.js"));
    return (_ctx, _cache) => {
...
var _hoisted_1$1 = { class: "vite-devtools-group-sidebar flex flex-col flex-none w-12 h-full border-r border-base of-y-auto of-x-hidden select-none py1.5 items-center gap-0.5" };
var _hoisted_2$1 = ["onPointerenter", "onClick"];
var _hoisted_3$1 = {
  key: 0,
...
var _hoisted_3 = { class: "border-r border-base flex flex-col min-h-0" };
var _hoisted_4 = { class: "p2 border-b border-base flex" };
var _hoisted_5 = { class: "transition duration-200 p2 of-y-auto" };
var _hoisted_6 = { class: "min-h-0 flex" };
var _hoisted_7 = { class: "relative flex-1 min-w-0 min-h-0" };
...
var DockStandalone_exports = __exportAll({ DockStandalone: () => DockStandalone });
var DockStandalone = defineCustomElement(_sfc_main, {
  shadowRoot: true,
  styles: [css_default]
});
...
export {
  ...
  _sfc_main$17,
  _sfc_main$13,
  PersistedDomViewsManager,
  PersistedDomHolder,
  _sfc_main$2,
  _sfc_main$1,
  DockStandalone_exports,
  DockStandalone
};
//# sourceMappingURL=chunk-UE3TDDX5.js.map
