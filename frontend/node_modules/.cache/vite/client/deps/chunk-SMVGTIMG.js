// node_modules/@vitejs/devtools/dist/iconify-Dk8bCkEz.js
...
var getIconifySvgMap = /* @__PURE__ */ new Map();
var purify = purify$1();
async function getIconifySvg(collection, icon) {
  ...
  const promise = _get().then((svg2) => {
    getIconifySvgMap.set(id, svg2);
    return svg2;
  });
  ...
  async function _get() {
    ...
    const svg2 = await fetch(url).then((res) => res.text());
...
//# sourceMappingURL=chunk-SMVGTIMG.js.map
