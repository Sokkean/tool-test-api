...
// node_modules/@vitejs/devtools/dist/client/webcomponents.js
...
var BracketLeft_default = export_helper_default(_sfc_main$7, [["render", _sfc_render$1]]);
var _sfc_main$6 = {};
var _hoisted_1$3 = {
  viewBox: "0 0 9 20",
  fill: "none",
...
var BracketRight_default = export_helper_default(_sfc_main$6, [["render", _sfc_render]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          createElementVNode("div", { class: normalizeClass([isMinimized.value ? "opacity-0 pointer-events-none" : "opacity-100", "transition duration-200 flex items-center w-full h-full justify-center px3"]) }, [createVNode(_sfc_main$13, {
            context: unref(context),
...
var _hoisted_1$1 = { class: "relative flex-1 min-w-0 h-full" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", { class: normalizeClass(["flex items-center shrink-0 select-none py1", toolbarClass.value]) }, [
          createElementVNode("div", { class: normalizeClass(["flex items-center flex-1 flex-wrap gap-0.5 px1", isVertical.value ? "flex-col py1" : "flex-row px1"]) }, [createVNode(_sfc_main$13, {
            context: unref(context),
        ...
        withDirectives(createElementVNode("div", { class: normalizeClass(["flex", contentClass.value]) }, [activeGroup.value ? (openBlock(), createBlock(_sfc_main$1, {
          key: 0,
          context: unref(context),
          ...
          "group",
          "selected-id"
        ])) : createCommentVNode("v-if", true), createElementVNode("div", _hoisted_1$1, [hasPanelContent.value && viewsContainer.value && selectedEntry.value ? (openBlock(), createBlock(_sfc_main$2, {
...
var _hoisted_1 = { class: "flex w-full h-full" };
var _hoisted_2 = { class: "relative flex-1 min-w-0 h-full" };
var _sfc_main$12 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("div", {
      ...
      }, [createVNode(_sfc_main$3, { panel: unref(context).panel }, null, 8, ["panel"]), createElementVNode("div", _hoisted_1, [activeGroup.value ? (openBlock(), createBlock(_sfc_main$1, {
        key: 0,
        context: unref(context),
        group: activeGroup.value,
        ...
        "group",
        "selected-id"
      ])) : createCommentVNode("v-if", true), createElementVNode("div", _hoisted_2, [unref(selected) && viewsContainer.value ? (openBlock(), createBlock(_sfc_main$2, {
...
var DockEmbedded = defineCustomElement(defineComponent({
  __name: "DockEmbedded",
  props: { context: {} },
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        !unref(isDockPopupOpen) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [isRpcTrusted.value && __props.context.panel.store.mode === "edge" ? (openBlock(), createBlock(_sfc_main$24, {
          key: 0,
          context: __props.context
          ...
          default: withCtx(({ dockEl, panelMargins, selected }) => [createVNode(_sfc_main$12, {
            context: __props.context,
            selected,
            "dock-el": dockEl,
          ...
          _: 1
        }, 8, ["context"])), createVNode(_sfc_main$18)], 64)) : createCommentVNode("v-if", true),
        createVNode(_sfc_main$23, { context: __props.context }, null, 8, ["context"]),
        createVNode(_sfc_main$19, { context: __props.context }, null, 8, ["context"]),
        !unref(isDockPopupOpen) ? (openBlock(), createBlock(_sfc_main$22, { key: 1 })) : createCommentVNode("v-if", true)
      ], 64);
    };
  }
}), {
...
//# sourceMappingURL=webcomponents-S6Z4NQQ6.js.map
